...
Forth, \ ( Comment ) \ Comment
Nu, echo "String" # Comment
Stylus, str: "String" // Comment
UnrealScript, Log("String"); // Comment
G-CODE, ( Comment ) stringunknown
GnuPlot, set title "String" # Comment
Mako, <note>String</note> <!-- Comment !-->
ASCIIDoc, String // Comment
AutoIt, MsgBox($MB_SYSTEMMODAL, "Message box title", "String") ; Comment
Uno, return "String"; // Comment
VimScript, echo "String" " Comment
Seed7, writeln("String\n") unknownComment
HAML, %p.sample#Str String /* Comment
LispFlavoredErlang, (io:format "String") ; Comment
Euphoria, puts (1, "String\n") -- Comment 
OpenPolicyAgent, request str1 = {"String"} # Comment
ABAP, WRITE "String". "! Comment
ALGOL, BEGIN DISPLAY("String") END. comment Comment comment
Thrift, string message(1:string message "String") // Comment /* Comment */
