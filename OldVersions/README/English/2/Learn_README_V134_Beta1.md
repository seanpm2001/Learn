...
<!-- <details open><summary><p><b>Click/tap here to expand/collapse this section</b></p></summary> DO NOT ADD A DROPDOWN HERE !-->
...
## Not to be confused with [Microsoft Learn](https://learn.microsoft.com)
...
- 2. configuration (count not available)
- 3. scripting (count not available)
- 4. markup (count not available)
- 5. markdown (count not available)
- 6. stylesheet languages (count not available)
- 7. shader languages (count not available)
- 8. machine code languages (count not available)
- 9. esoteric languages (count not available)
- 10. typesetting languages (count not available)
- 11. image languages (count not available)
- 12. audio languages (count not available)
- 13. block-based languages (count not available)
- 14. database languages (count not available)

See: [`LEARN_REPOLIST.urll`](/LEARN_REPOLIST.urll) for a full, plain text listing
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/seanpm2001/Learn-Clean/"><img src="/Programming/Logos/C/Clean/Clean_3.0_(programming_language)_logo.svg" width="100px;" alt=""/><br /><sub><b>Learn Clean</b></sub></a></td>
  </tr>
  <!-- Row 3B !-->
  <!-- Letter C !-->
  <tr>
...
**File version:** `134 (2023, Thursday, August 10th at 03:41 pm PST)`

**Line count (including blank lines and compiler line):** `10,703`

**Word count:** `58,085`

**Character count (including spaces):** `397,277`

**Character count (excluding spaces):** `344,19`

**Size (in bytes):** `399,937`
...
- [x] Updated the `Learn` table
- - [x] Added support for Haxe, HXML, Rascal, and RouterOS Script
- - [x] Added a new 8th column for language letters/numbers
- [x] Updated the `//` comment section to include Haxe
- [x] Updated the `#` comment section to include HXML, Rascal, and RouterOS Script
- [x] Updated the file info section
- [x] Updated the file history section
...
- [x] Updated the `Learn` table
- - [x] Added support for Astro, Bikeshed, Cool, Eagle, and Logcat
- [x] Updated the comments section
- - [x] Updated the `//` comment section to include Astro
- - [x] Updated the `--` comment section to include Cool
- - [x] Updated the `<!-- !-->` comment section to include Bikeshed and Eagle
- - [x] Updated the `(* *)` comment section to include Cool
- - [x] Updated the `#` comment section to include Logcat
- [x] Updated the strings section
- - [x] Added the `out_string("String.\n")` section to include Cool
- [x] Updated the file info section
- [x] Updated the file history section
...
- [x] Updated the `Learn` table
- - [x] Added support for CartoCSS, G-CODE, GnuPlot, Mako, and Pug
- [x] Updated the file info section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
- [x] Updated the `Learn` table
- - [x] Added support for DTrace, HAML, HLSL, GLSL, and LispFlavoredErlang (LFE)
- [x] Updated the file info section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
- [x] Updated the `Learn` table
- - [x] Added support for Euphoria, Gosu, OpenPolicyAgent, SaltStack, and XProc
- [x] Updated the file info section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
- [x] Updated the `Learn` table
- - [x] Added support for ABAP, HiveQL, PureData, QMake, and XQuery
- [x] Updated the file info section
- - [x] Updated the version number
- - [x] Updated the version date
- - [x] Updated the line count
...
<details><summary><b>Version 104 (2023, Thursday, January 26th at 4:06 pm PST)</b></summary>
...
- [x] Updated the `Learn` table
- - [x] Added support for While
- [x] Updated the source code comments section
- - [x] Updated the `Unknown` section to include While
- [x] Updated the print statement section
- - [x] Updated the `Unknown` section to include While
- [x] Updated the file info section
- - [x] Updated the version number
...
- - [x] Updated the line count
- [x] Updated the file history section
- - [x] Added a log entry for version 104
...
- [x] Updated the `Learn` table
- - [x] Added a counter and related information
...
<details><summary><b>Version 134 (2023, Thursday, August 10th at 03:41 pm PST)</b></summary>
...
<details><summary><b>Version 207 (Coming soon)</b></summary>
...
<details><summary><b>Version 208 (Coming soon)</b></summary>
...
( [Back to top](#Learn) | [Exit to GitHub](https://github.com) | [Exit to Bing](https://www.bing.com/) | [Exit to DuckDuckGo](https://duckduckgo.com/) | [Exit to Safe.DuckDuckGo](https://safe.duckduckgo.com/) | [Exit to Ecosia](https://www.ecosia.org) | [Exit to Swisscows](https://www.swisscows.com/) )
