...
# [2023, Tuesday, December 26th](#2023-Tuesday-December-26th) <!-- TODO: This line should be updated daily !-->

## [Phase 6 day 173 (unfrozen)](#Phase-6-day-173-unfrozen) <!-- TODO: This line should be updated daily !-->
...
- [`Days since 2023, Friday, July 7th`](https://duckduckgo.com/?q=days+since+july+7th+2023&t=ffab&ia=answer) (`172`) - **As of/Last checked:** _2023, Tuesday, December 26th <!-- TODO: This line should be updated daily !-->
...
- **TODO list as of:** _2023, Tuesday, December 26th._ <!-- TODO: This line should be updated daily !-->
...
- ***Progress as of:*** `2023, Tuesday, December 26th` <!-- TODO: This line should be updated daily !-->
...
13. **CAP** (2024, Friday, January 12th) (`17` days left until start) [`Source (last checked: 2023.08.19)`](https://duckduckgo.com/?t=ffab&q=Days+until+January+12th+2024&ia=answer)
...
43. **Semantic Web Rule Language (SWRL)** (2024, Friday, February 23rd) (`59` days left until start) [`Source (last checked: 2023.11.28)`](https://duckduckgo.com/?t=ffab&q=Days+until+February+23rd+2024&ia=answer)
...
6. I came across a new language on 2023, Monday, August 14th (`POP-2`) but didn't write it down until 2023, Tuesday, August 15th. I cannot start work with this language until 2024, Wednesday, January 3rd.
...
31. I came across a new language during the night of 2023, Saturday, October 21st (`Apache Avro`) via Wikipedia. I cannot start work with this language until 2024, Wednesday, February 7th
...
37. I came across a new language on 2023, November 8th (`Lasso`) during my daily GitHub forking process. I cannot start work with this language until 2024, Thursday, February 15th
38. I came across 2 new languages on 2023, November 24th during my GitHub forking process, the first one was (`Elvish`) I cannot start work with this language until 2024, Friday, February 16th
39. I came across 2 new languages on 2023, November 24th during my GitHub forking process, the second one was (`NuShell`) I cannot start work with this language until 2024, Monday, February 19th
40. I came across a new language on 2023, November 25th (`Nearley`) during my daily GitHub forking process. I cannot start work with this language until 2024, Tuesday, February 20th
41. I came across a new language on 2023, November 24th but forgot to mention it until 2023, November 26th (`Datalog`) the language was discovered via Wikipedia. I cannot start work with this language until 2024, Wednesday, February 21st
42. I came across a new language on 2023, November 24th but forgot to mention it until 2023, November 26th (`Flix`) the language was discovered via Wikipedia. I cannot start work with this language until 2024, Thursday, February 22nd
43. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 1 is the following (`Semantic Web Rule Language (SWRL)`) I cannot start work with this language until 2024, Friday, February 23rd
44. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 2 is the following (`Semantic Query Web Rule Language (SQWRL)`) I cannot start work with this language until 2024, Monday, February 26th
45. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 3 is the following (`RuleML`) I cannot start work with this language until 2024, Tuesday, February 27th
46. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 4 is the following (`DARPA Agent Markup Language (DAML)`) I cannot start work with this language until 2024, Wednesday, February 28th
47. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 5 is the following (`REWERSE Rule Markup Language (R2ML)`) I cannot start work with this language until 2024, Thursday, February 29th
48. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 6 is the following (`Rule Interchange Format (RIF)`) I cannot start work with this language until 2024, Friday, March 1st
49. I came across 7 new languages via Wikipedia after finishing the Learn log for the night, of which entry 7 is the following (`LegalXML`) I cannot start work with this language until 2024, Monday, March 4th
50. I came across a new language (`LilyPond`) on 2023, Saturday, December 2nd due to a side task (a fork, if you will) of my daily fork process. I cannot start work with this language until 2024, Tuesday, March 5th
51. I came across a new language (`Cassandra Query Language (CQL)`) on 2023, Wednesday, December 13th via Wikipedia. I cannot start work with this language until 2024, Wednesday, March 6th.
...
- **File version:** `1 (2023, Tuesday, December 26th at 09:50 pm PST)` <!-- TODO: This line should be updated daily !-->
- **Line count (including blank lines and compiler line):** `1,194` <!-- This line doesn't always need to be updated daily !-->
- **Word count:** `19,008` <!-- TODO: This line should be updated daily !-->
- **Character count (including spaces):** `122,060` <!-- TODO: This line should be updated daily !-->
- **Character count (excluding spaces):** `101,777` <!-- TODO: This line should be updated daily !-->
- **Size (in bytes):** `126,249` <!-- TODO: This line should be updated daily !-->
...
## [Version 1 (2023, Tuesday, December 26th at 09:50 pm PST)](#Version-1-2023-Tuesday-December-26th-at-09-55-pm-PST) <!-- TODO: This line should be updated daily !-->
...
> **Note** _The second day of new work in the newest streak. Continuing for a 7th consecutive day._ <!-- TODO: This line should be updated daily !-->
...
- [Back to top](#2023-Tuesday-December-26th) <!-- TODO: This line should be updated daily !-->
